...
The **Flash Viewer** is configured using the properties in the **StiNetCoreViewerFxOptions** class. All properties are divided into groups, some of the groups contain subgroups. The following is an example of setting the properties of the viewer.
...
| Exit | Specifies the name of the action method to go to the specified view when [clicking the Exit button](Export_Report_from_Code.md) on the viewer panel. |
