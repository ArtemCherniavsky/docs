...
To run the designer, you need to place the **StiNetCoreDesignerFx** component on the page, set the necessary properties and, if necessary, set the necessary actions on the view controller. When the report designer runs, the following actions occur:
