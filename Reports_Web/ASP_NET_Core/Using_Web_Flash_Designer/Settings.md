...
The **Flash Designer** configuration is done using properties that are located in the **StiNetCoreDesignerFxOptions** class. All properties are divided into groups, some of the groups contain subgroups of properties for ease of use. Below is an example of setting some properties of the designer.
...
| Exit | Specifies the name of the action method to go to the desired view by clicking [the Exit button](Additional_Methods.md) in the main menu of the report designer. |
| DesignerEvent | Specifies the name of the action method of the report designer to handle [additional designer actions](Additional_Methods.md) such as working with data, previewing the report, viewing the C#/VB.Net report code, and others. Also, this action is used to load scripts and designer styles. |
