...
> **Information**
>
> See  on [GitHub](https://github.com/stimulsoft/Samples-Dashboards-NET.Core-3.1-MVC-CSharp) example of adding a custom function in the ASP.NET MVC HTML5 Designer component.
