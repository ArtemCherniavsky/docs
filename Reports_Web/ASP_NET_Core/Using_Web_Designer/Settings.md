...
| RouteTemplate | Sets the route template that is returned when the report designer actions are executed. If the property is not set, then the MVC project template will be used instead. The default value of the property is null. If the `UseRelativeUrls` property is set to `true`, the `BasePath` will not be respected for this property.The default value of this property is null. |
