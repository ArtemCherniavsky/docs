...
When working with the **StiNetCoreViewer** component, you can set the timeout for various operations — [storing the report in the cache](../../ASP_NET_Core/Using_Web_Viewer/Timeout.md), [server response](../../ASP_NET_Core/Using_Web_Viewer/Timeout.md), and [query execution](../../ASP_NET_Core/Using_Web_Viewer/Timeout.md). The timeout setting is done using the component properties and report options.
