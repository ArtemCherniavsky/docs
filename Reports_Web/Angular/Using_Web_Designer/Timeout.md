...
When working with the **StiNetCoreDesigner** component, you can set the timeout for various operations — [storing the report in the cache](../../ASP_NET_Core/Using_Web_Designer/Timeout.md), [server response](../../ASP_NET_Core/Using_Web_Designer/Timeout.md), and [query execution](../../ASP_NET_Core/Using_Web_Designer/Timeout.md). The timeout setting is done using the component properties and report options.
...
Using cache will increase the speed of the report designer. See the chapter [Caching](../../ASP_NET_Core/Using_Web_Designer/Caching.md) for more information
